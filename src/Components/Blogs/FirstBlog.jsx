  ...
  const toc = [
...

    {
      ...
      children: [
        ...
        { id: "gupshup", label: "3.2 WATI" },
        { id: "wati", label: "3.3 Getgabs" },
        { id: "twilio", label: "3.4 Gupshup" },
        { id: "karix", label: "3.5 Twilio" },
        { id: "route", label: "3.6 Karix" },
        { id: "infobip", label: "3.7 Route Mobile" },
        { id: "kaleyra", label: "3.8 Infobip" },
        { id: "messagebird", label: "3.9 Kaleyra" },
        { id: "vonage", label: "3.10 MessageBird" },
      ],
    },
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10 items-start">
            ...
            <main className="col-span-12 md:col-span-6 space-y-8 animate-fadeIn">
              ...
              <section id="providers" className="scroll-mt-28 animate-section">
                ...
                <section id="wati">
                  <h3 className="font-semibold text-emerald-600 mt-5 text-xl" >2. WATI - Best for SMBs and fast onboarding</h3>
                ...
                <section id="Getgabs">
                  <h3 className="font-semibold text-emerald-600 mt-5 text-xl" >3. Getgabs - Best for SMBs, E-commerce, and Growing Businesses</h3>
                  ...
                  <p className="text-gray-700 text-[15px] sm:text-base">
                    <Link
                      to="https://getgabs.com/whatsapp-business-api/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 underline hover:text-blue-800"
                    >{"  "}Getgabs {"  "}</Link>is an official WhatsApp business API provider in India that offers a complete marketing and AI-driven automation solution. It helps brands run broadcast campaigns, automate customer support via AI chatbots, integrate with CRM systems, and streamline sales and support via WhatsApp automation. With 0% markup on Meta cost and no setup fees, Getgabs emerges as a cost-effective solution for SMBs, e-commerce, and growing brands looking to scale their customer communication and marketing on WhatsApp. The basic plan starts at ₹399/month.
                  </p>
                  <h4 className="font-semibold text-emerald-600 mt-2 text-xl">Key Features :</h4>
                  <ul className="ml-5 list-disc">
                    <li className="text-gray-700 text-[15px] sm:text-base" > WhatsApp Business API integration for seamless business communication</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >Built-in CRM to manage customer conversations, leads, and sales in one place</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >Bulk WhatsApp broadcasting for promotional campaigns and customer updates</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >AI-powered WhatsApp chatbot to automate customer support, sales, and lead qualification</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >Shared team inbox with multi-agent support for collaborative customer communication</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >Click-to-WhatsApp Ads integration to convert Facebook and Instagram ad clicks into chats</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >Shopify and eCommerce automation for order updates, abandoned cart recovery, and customer engagement</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >Advanced contact segmentation for personalized messaging and targeted campaigns</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >Automated drip campaigns to nurture leads and improve customer retention</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >CRM integrations with popular business tools for a unified workflow</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >Real-time analytics and reporting to track campaign performance and customer engagement</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >WhatsApp chat widget for capturing website visitors and generating more leads</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >Voice calling support for faster and more personalized customer interactions</li>
                    <li className="text-gray-700 text-[15px] sm:text-base" >AI Agent to handle customer queries, automate workflows, and provide 24/7 conversational support</li>

                  </ul></section>


                <section id="gupshup">
                  <h3 className="font-semibold text-emerald-600 mt-5 text-xl" >4. Gupshup - Best for India-first scale & templates</h3>
                ...
                <section id="twilio">
                  <h3 className="font-semibold text-emerald-600 mt-5 text-xl" >5. Twilio - Best for developers and global operations</h3>
                ...
                <section id="karix">
                  <h3 className="font-semibold text-emerald-600 mt-5 text-xl" >6. Karix - Best for omnichannel engagement in India</h3>
                ...
                <section id="route">
                  <h3 className="font-semibold text-emerald-600 mt-5 text-xl" >7. Route Mobile - Best for telco-scale messaging</h3>
                ...
                <section id="infobip">
                  <h3 className="font-semibold text-emerald-600 mt-5 text-xl" >8. Infobip - Best for enterprise orchestration and analytics</h3>
                ...
                <section id="kaleyra">
                  <h3 className="font-semibold text-emerald-600 mt-5 text-xl" >9. Kaleyra (Tata Communications Kaleyra) - Best for reliable CPaaS & compliance</h3>
                ...
                <section id="messagebird">
                  <h3 className="font-semibold text-emerald-600 mt-5 text-xl" >10. MessageBird - Best for omnichannel UX & European/global reach</h3>
