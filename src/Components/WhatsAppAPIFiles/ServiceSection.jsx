...
import { Plus, Minus, Info, TrendingUp, Clock, MessageCircle, ShieldCheck, DollarSign } from "lucide-react";
...
const ServiceSection = () => {
  ...
  const unlimitedTooltipMap = {
    "Team Members - Unlimited": "Max 100 team members allowed",
...
px-4 sm:px-6 overflow-hidden">
          ...
          <div className="max-w-xl mx-auto mt-12 px-4">
            <div className="relative">
              ...
              `}
                      ...
                      {/* LABEL */}
                      <span
                        className={`mt-3 text-sm transition-all ${isActive
  ...
  `}
    ...
    "
                  ...
                  {plan.chatbots.some(limit => limit.includes("Google Dialogflow")) && (
                    <>
                      <div className="w-full h-[1px] bg-black/10 my-4"></div>
                      <div className="">
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-emerald-300 rounded-full flex p-1 gap-1">
              {[
                ...
                <button
                  key={key}
                  onClick={() => setBilling(key)}
                  className={`px-5 py-2 rounded-full text-sm transition-all cursor-pointer ${billing === key
          ...
          <div className="col-span-2 space-y-4">
            {faqs.map((item, index) => (
              ...
              >
                ...
                {/* ANSWER */}
                <div
                  className={`overflow-hidden transition-all duration-300 ${openIndex === index ? "max-h-40 p-4 sm:p-5" : "max-h-0 p-0"
                    }`}
                >
