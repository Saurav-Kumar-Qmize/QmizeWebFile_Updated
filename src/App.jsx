...
import WhatsappbusinessApiSaudiArabia from "./Components/Pages/WhatsappbusinessApiSaudiArabia";
...
import FourtyTwoBlog from "./Components/Blogs/FourtyTwoBlog";
...
import FourtySevenBlog from "./Components/Blogs/FourtySevenBlog";
import FourtyEightBlog from "./Components/Blogs/FourtyEightBlog";
import FourtyNineBlog from "./Components/Blogs/FourtyNineBlog";
import FiftyBlog from "./Components/Blogs/FiftyBlog";
import FiftyOneBlog from "./Components/Blogs/FiftyOneBlog";
import FiftyTwoBlog from "./Components/Blogs/FiftyTwoBlog";
import FiftyThreeBlog from "./Components/Blogs/FiftyThreeBlog";
import FiftyFourBlog from "./Components/Blogs/FiftyFourBlog";
import FiftyFiveBlog from "./Components/Blogs/FiftyFiveBlog";
import FiftySixBlog from "./Components/Blogs/FiftySixBlog";
import FiftySevenBlog from "./Components/Blogs/FiftySevenBlog";
    ...
    <BrowserRouter>
      <LenisProvider>
        ...
        <Routes>
          ...
          <Route path="/whatsapp-business-api-saudi-arabia" element={<WhatsappbusinessApiSaudiArabia />} />
         ...
         <Route path="/blog/meta-certified-whatsapp-business-api-provider-checklist" element={<FourtySevenBlog />} />         
         <Route path="/blog/send-whatsapp-messages-0-markup-charge" element={<FourtyEightBlog />} />         
         <Route path="/blog/whatsapp-vs-sms-for-businesses" element={<FourtyNineBlog />} />         
         <Route path="/blog/whatsapp-business-messaging/" element={<FiftyBlog />} />            
         <Route path="/blog/best-whatsapp-automation-tools/" element={<FiftyOneBlog />} />            
         <Route path="/blog/faq-chatbot/" element={<FiftyTwoBlog />} />            
         <Route path="/blog/best-whatsapp-business-api-providers-in-saudi-arabia" element={<FiftyThreeBlog />} />            
         <Route path="/blog/whatsapp-chatbot-example" element={<FiftyFourBlog />} />            
         <Route path="/blog/whatsapp-business-web-qr-code-guide" element={<FiftyFiveBlog />} />            
         <Route path="/blog/best-whatsapp-api-platforms" element={<FiftySixBlog />} />            
         <Route path="/blog/best-whatsapp-business-api-providers-india" element={<FiftySevenBlog />} />            
